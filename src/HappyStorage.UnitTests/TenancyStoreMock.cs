...
namespace HappyStorage.UnitTests
{
    internal class TenancyStoreMock : ITenancyStore
    {
        ...
        public IEnumerable<TenantLookup> ListTenants() => Tenants.Select(t => new TenantLookup(t.UnitNumber, t.CustomerNumber, t.ReservationDate, t.AmountPaid, t.IsLocked, t.LockedDateTime));
